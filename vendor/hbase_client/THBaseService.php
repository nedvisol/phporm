...
interface THBaseServiceIf {
  public function exists($table, $get);
  public function get($table, $get);
  public function getMultiple($table, $gets);
  public function put($table, $put);
  public function checkAndPut($table, $row, $family, $qualifier, $value, $put);
  public function putMultiple($table, $puts);
  public function deleteSingle($table, $deleteSingle);
  public function deleteMultiple($table, $deletes);
  public function checkAndDelete($table, $row, $family, $qualifier, $value, $deleteSingle);
  public function increment($table, $increment);
  public function openScanner($table, $scan);
...
class THBaseServiceClient implements THBaseServiceIf {
  ...
  public function send_exists($table, $get)
  {
  ...
  public function send_get($table, $get)
  {
  ...
  public function send_put($table, $put)
  {
  ...
  public function send_checkAndPut($table, $row, $family, $qualifier, $value, $put)
  {
  ...
  public function send_deleteSingle($table, $deleteSingle)
  {
  ...
  public function send_checkAndDelete($table, $row, $family, $qualifier, $value, $deleteSingle)
  {
  ...
  public function send_increment($table, $increment)
  {
  ...
  public function send_openScanner($table, $scan)
  {
  ...
  public function write($output) {
    ...
    if ($this->deletes !== null) {
      ...
      $xfer += $output->writeFieldBegin('deletes', TType::LST, 2);
      {
        ...
        {
          foreach ($this->deletes as $iter69)
          {
